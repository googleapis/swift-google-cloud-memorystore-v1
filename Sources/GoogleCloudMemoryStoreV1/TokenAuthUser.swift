...
public struct TokenAuthUser: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var state: TokenAuthUser.State = TokenAuthUser.State()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `TokenAuthUser`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TokenAuthUser().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(TokenAuthUser.State.self, forKey: .state) {
      self.state = value
    }
