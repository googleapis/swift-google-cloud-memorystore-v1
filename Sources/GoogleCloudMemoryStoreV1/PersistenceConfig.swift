  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.rdbConfig = try container.decodeIfPresent(
      PersistenceConfig.RDBConfig.self, forKey: .rdbConfig)
    self.aofConfig = try container.decodeIfPresent(
      PersistenceConfig.AOFConfig.self, forKey: .aofConfig)
  ...
  public struct RDBConfig: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  public struct AOFConfig: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public enum AppendFsync: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .everySec: return try container.encode("EVERY_SEC")
