...
public struct WeeklyMaintenanceWindow: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.memorystore.v1.WeeklyMaintenanceWindow"
  }
