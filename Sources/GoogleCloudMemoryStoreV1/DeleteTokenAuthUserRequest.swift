...
public struct DeleteTokenAuthUserRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteTokenAuthUserRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteTokenAuthUserRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.memorystore.v1.DeleteTokenAuthUserRequest"
  }
