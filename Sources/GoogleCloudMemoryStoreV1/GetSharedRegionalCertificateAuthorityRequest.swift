...
public struct GetSharedRegionalCertificateAuthorityRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetSharedRegionalCertificateAuthorityRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetSharedRegionalCertificateAuthorityRequest().with { $0.name = ... }
  /// ```
