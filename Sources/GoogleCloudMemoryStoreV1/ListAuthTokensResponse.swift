...
public struct ListAuthTokensResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let authTokens = CodingKeys(stringValue: "authTokens")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AuthToken].self, forKey: .authTokens) {
      self.authTokens = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.authTokens, forKey: .authTokens)
...
extension ListAuthTokensResponse: GoogleGax._PaginatedResponse {
