...
/// connections.
public struct PscAttachmentDetail: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `PscAttachmentDetail`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PscAttachmentDetail().with { $0.serviceAttachment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.memorystore.v1.PscAttachmentDetail"
  }
