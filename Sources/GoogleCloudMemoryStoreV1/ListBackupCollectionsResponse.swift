...
public struct ListBackupCollectionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var backupCollections: [BackupCollection] = []
  ...
  /// Initialize a new instance of `ListBackupCollectionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackupCollectionsResponse().with { $0.backupCollections = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let backupCollections = CodingKeys(stringValue: "backupCollections")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [BackupCollection].self, forKey: .backupCollections)
    {
      self.backupCollections = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.backupCollections, forKey: .backupCollections)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.memorystore.v1.ListBackupCollectionsResponse"
  }
...
extension ListBackupCollectionsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [BackupCollection] {
    return self.backupCollections
  }
