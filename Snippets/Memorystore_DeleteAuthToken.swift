...
func sample(
  ...
  let poller = try await client.deleteAuthToken(
    withPolling: DeleteAuthTokenRequest()
      .with {
        $0.name =
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        instanceId: "[placeholder]", tokenAuthUserId: "[placeholder]", authTokenId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
